                    ...
                    <td align="center" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                                <tbody><tr>
                                    ...
                                    <h3>Estimado {{$name}},</h3>
                                        <h2><strong>Bienvenidos al cambio de password.</strong></h2>
                                        <p>En el siguiente correo contiene el enlace que lo direccionara a una pagina para que pueda realizar el cambio de passwrod .</p>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
                    ...
                    <td align="center" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                                <tbody><tr>
                                    ...
                                    <a class="blue-btn" href="{{$url}}"><strong>Cambio de Password</strong></a>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                            <tbody><tr>
                                <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                    ...
                                    <h6 style="text-align:center;margin-top: 9px;">Almacen Los Yuyitos </h6>
                                    <h6 style="text-align:center;">Av. Los Yuyitos 666</h6>
                                    <h6 style="text-align:center;">Maipu, Santiago​</h6>
                                </td>
                            </tr>
                        </tbody></table>
                    </td>
