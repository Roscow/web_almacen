...
<div class="form-row">        
        ...
        <div class="form-group col-md-4">
            ...
            <select name="familia" id="inputState" class="form-control">
                <option selected>Elegir...</option>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" name="precio_compra" class="form-control" id="inputAddress" placeholder="0">
        </div>

        <div class="form-group col-md-6">
            <label for="inputEmail4">Precio de venta</label>
            <input type="number" name="precio_venta" class="form-control" id="inputEmail4" placeholder="0">
        </div>           
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" name="stock" class="form-control" id="inputAddress" placeholder="0">
        </div> 

        <div class="form-group col-md-6">
            <label for="inputAddress">stock critico</label>
            <input type="number" name="stock_critico" class="form-control" id="inputAddress" placeholder="0">
        </div>    
    </div>
